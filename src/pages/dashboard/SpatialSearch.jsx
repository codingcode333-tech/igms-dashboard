...
export const SpatialDataDisplay = ({
    ...
    const getGrievances = async (temp = null) => {
        try {
            ...
            setTotal(data.total_count?.total_count || data.total_count || data.count || list.length)
            ...
            console.log('📋 Grievance list updated:', {
                ...
                finalTotal: data.total_count?.total_count || data.total_count || data.count || list.length
            });
                                ...
                                <CardBody className="p-3">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <Typography variant="small" color="gray" className="text-xs">
                                                Found {count} grievances | Total {total} records
                                            </Typography>
                                        </div>
                                    </div>
